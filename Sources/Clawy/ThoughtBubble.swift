...
struct ThoughtBubble {
    ...
    private static func bashMessage(for command: String) -> String? {
        ...
        case "head":     return "Heady noddy?"
        case "tail":     return "Taily waggy?"
        case "less":     return "Say less?"
        case "more":     return "Gimme more?"
        case "wc":       return "Wordy county?"
        case "sort":     return "Sorty sorty?"
        case "diff":     return "Diffy spiffy?"
        case "ls":       return "Lookie lookie?"
        case "cd":       return "Seedy seedy?"
        case "echo":     return "Echoey echoey?"
        case "ln":       return "Linky linky?"
        ...
        case "scp":      return "Syncy syncy?"
        case "rsync":    return "Syncy syncy?"
        ...
        case "ping":     return "Pingy pongy?"
        case "claude":   return "Clawy clawy?"
        case "ts-node":  return "Nodey nodey?"
        case "tsx":      return "Nodey nodey?"
        default:         return nil
        }
    }
}
